  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          role="menu"
          className="absolute top-full right-0 mt-2 w-32 bg-white dark:bg-zinc-900 border border-black/10 dark:border-white/10 z-50 py-1 animate-in fade-in zoom-in-95 duration-200 rounded-xl shadow-lg overflow-hidden"
        >
          <button
            type="button"
